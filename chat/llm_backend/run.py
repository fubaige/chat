...
# 强制将本地源码路径加入 sys.path，确保优先使用 app/graphrag 和本地微信服务代码
sys.path.insert(0, str(Path(__file__).parent / "app" / "graphrag"))
sys.path.insert(0, str(Path(__file__).parent.parent / "wx-mp-svr-main" / "src"))
